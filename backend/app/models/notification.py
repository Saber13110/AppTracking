...
class Notification(BaseModel):
    ...
    priority: NotificationPriority = Field(
        default=NotificationPriority.MEDIUM, description="Notification priority")
    tracking_number: Optional[str] = Field(
        None, description="Associated tracking number if applicable")
    is_read: bool = Field(
        default=False, description="Whether the notification has been read")
    created_at: datetime = Field(
        default_factory=datetime.now, description="When the notification was created")
